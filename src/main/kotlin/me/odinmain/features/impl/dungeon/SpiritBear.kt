...
object SpiritBear : Module(
    ...
    private inline val blockLocation: get() = if (DungeonUtils.floor?.isMM == true) m4BlockLocation else f4BlockLocation
    private inline val killsNeeded: get() = if (DungeonUtils.floor?.isMM == true) 30 else 20
